...
void admin::donor_application(){
    ...
    while (!in_file.eof())
    {
        ...
        >> donor_apps.blood_group >> donor_apps.amount_of_blood ;
        ...
        if (response == 1)
        {
            ...
            << std::endl << donor_apps.blood_group << std::endl << donor_apps.amount_of_blood << std::endl <<date<< std::endl;
            out_file.close();
            }
        else if (response == 2)
            {
...
void admin::blood_sample_list(){
    ...
    while (!in_file.eof())
    {
        ...
        std::cout << "\nDate when blood is received: " <<date;
            ...
            while (!in_file.eof())
                {
                    ...
                    std::cout << "\nHospital license id : " << info.license_id;
                    std::cout << "\nRequested Blood group : "<<info.blood_group;
                    std::cout << "\nRequested Quantity (L) : "<<info.amount_of_blood;
                }
                    std::cout<<std::endl<<std::endl;
                    in_file.close();
        }
    ...
    case 2:
        {
            ...
            while (1)
            {
                ...
                if (id == (info.license_id))
                {
                    ...
                    << info.blood_group << std::endl << info.amount_of_blood << std::endl;
    ...
    case 3:
        {
                        ...
                        while (1)
            {
                ...
                out_file<< info.hospital_name<< std::endl << info.license_id<<std::endl << info.blood_group << std::endl << info.amount_of_blood << std::endl ;
